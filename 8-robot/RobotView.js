...

{
  class View {
    ...
    renderTextArea(parent) {
      return View.createAndAppend('textarea', parent, { class: 'json-input', name: 'json-data' });
    }
    ...
    addSelectElement(parent) {
      this.selectElem = View.createAndAppend('select', parent, { id: 'levels' });
    ...
    renderSelectOptions() {
      ...
      this.model.levels.forEach(level => {
        View.createAndAppend('option', this.selectElem, { value: level.id, text: level.title });
      });
    }
  }
